  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og:site_name', name: 'og:site_name', content: 'Barcode Generator' },
      { hid: 'apple-mobile-web-app-title', name: 'apple-mobile-web-app-title', content: 'Barcode Generator' },
      { hid: 'og:title', name: 'og:title', content: 'Barcode Generator' },
